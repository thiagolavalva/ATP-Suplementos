...
alter table public.atp_customers enable row level security; alter table public.atp_coupons enable row level security;
...
begin
 ...
 foreach item in array select array_agg(value) from jsonb_array_elements(o.items) loop
