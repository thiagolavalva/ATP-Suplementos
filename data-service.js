(() => {
  ...
  if(!configured){window.ATPData={mode:'sin-configurar',getProducts:reject,getSettings:reject,signIn:reject,signOut:async()=>{},getSession:async()=>null,getOrders:async()=>[],getCustomers:async()=>[],getCoupons:async()=>[],saveCoupon:reject,deleteCoupon:reject,updateOrder:reject,deleteOrder:reject};return}
